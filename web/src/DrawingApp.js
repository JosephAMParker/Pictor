...
const DrawingApp = (props) => {
    const { setStarPoint, penSize, drawMode, initialized, setInitialized, height, width, forwardedRef, hidden, originalImage, inFilter }  = props
    ...
    }, [drawMode, penSize, isDrawing, width, height]);
  ...
  return (
    <>
        <div style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 10, opacity: hidden ? 0 : 0.25}}>
          <canvas ref={canvasRef} style={{width: '100%', height: '100%', maxWidth: '100%', margin: 0, padding: 0 }}/>
        </div>
        <div hidden={inFilter} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 9}}>
        ...
        <canvas hidden ref={originalRef} style={{width: '100%', height: '100%', maxWidth: '100%', margin: 0, padding: 0}}/>
        <div hidden={drawMode!='star'} style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', zIndex: 9}}>
